...
def download_report_pdf(request, rid):
    ...
    p.drawString(200, 750, "DermSkin AI Report")

    p.setFont("Helvetica", 12)
    p.drawString(100, 700, f"Disease Detected: {report.disease}")
    p.drawString(100, 670, f"Confidence Level: {report.confidence}%")
    p.drawString(100, 640, f"Report Date: {report.report_date}")

    p.drawString(100, 600, "Generated by DermSkin AI Dermatology Assistant")
